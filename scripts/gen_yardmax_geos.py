...
<meta name="contact" content="info@deviceglowhub.com">
...
{{
  ...
  "@type": "Product",
  "name": "YardMax™",
  "image": "https://deviceglowhub.com/assets/img/products/yardmax/hero.webp",
  ...
  "offers": {{
    ...
    "url": "https://deviceglowhub.com/{geo}/{slug}/landing.html"
  }},
  ...
  <div class="wrap">
    ...
    <div class="order-card">
      ...
      <form class="tm-order-form order-form" action="{form_action}" method="post">
        ...
        <input name="thankyoupage" type="hidden" value="https://deviceglowhub.com/{geo}/{slug}/thank-you.html"/>
...
<footer class="site-footer">
  <div class="container">
    <div class="site-footer__grid">
      <div>
        <a href="/" class="site-logo" aria-label="deviceglowhub.com home">
          <span class="site-logo__text"><span class="site-logo__text-primary">deviceglowhub</span><span class="site-logo__text-accent">.com</span></span>
        </a>
      ...
      <div>
        ...
        <ul class="site-footer__list">
          <li><strong>COD KINGDOM LLC</strong></li>
          <li>111 NE 1st St, 8th Floor 88730</li>
          <li>Miami, FL 33132, United States</li>
          <li><a href="mailto:info@deviceglowhub.com">info@deviceglowhub.com</a></li>
        </ul>
      </div>
    </div>
    <div class="site-footer__bottom">
      © <span data-year>2026</span> <strong>COD KINGDOM LLC</strong> — {rights}
      <a href="/">deviceglowhub.com</a>
    </div>
  </div>
</footer>
...
def render_thank_you(geo: str, cfg: dict, t: dict, base_ty: str) -> str:
    ...
    html = html.replace(
        "Il team deviceglowhub al lavoro: call center e logistica COD", t["ty_alt"]
    )
