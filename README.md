# deviceglowhub.com — COD Multi-Geo Static Site
...
- **Company**: Eazy commerce srls — STRADA IV DESTRA, Via Lemitone, 13, 81030 Casaluce, Italy
...
This site is **100% static**. Deploy by uploading the entire `/deviceglowhub.com/` folder to any static host:
